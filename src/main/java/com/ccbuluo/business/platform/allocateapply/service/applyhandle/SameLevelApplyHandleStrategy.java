...
public class SameLevelApplyHandleStrategy extends DefaultApplyHandleStrategy {
    ...
    public int applyHandle(BizAllocateApply ba){
        ...
        try {
            ...
            Pair<List<BizOutstockplanDetail>, List<BizInstockplanDetail>> pir = buildOutAndInstockplanDetail(details, stockDetails, AllocateApplyEnum.SERVICEALLOCATE, relOrdstockOccupies);
            // 保存占用库存

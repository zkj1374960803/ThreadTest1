...
public interface StockDetailService {
     ...
     */
    Long getByinstockorderDeatil(String supplierNo, String productNo, BigDecimal costPrice, String inRepositoryNo, String applyNo, String purchaseNo);
    ...
    */
     ...
     */
    List<StockAdjustListDTO> queryAdjustList(List<String> equipmentCodes, String orgCode, String productType);

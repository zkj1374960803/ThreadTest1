...
public class QueryAllocateApplyListDTO {
     ...
     * 申请来源
     */
    @ApiModelProperty(name = "orgType", value = "申请来源(SERVICECENTER(服务中心),CUSTMANAGER(客户经理)SERVICEPLATFORM(售后平台);)")
    ...
    @ApiModelProperty(name = "instockOrgName", value = "入库机构的名称")
    private String instockOrgName;

    @ApiModelProperty(name = "processOrgno", value = "处理机构")

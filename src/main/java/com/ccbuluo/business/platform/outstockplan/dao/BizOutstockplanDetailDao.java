...
public class BizOutstockplanDetailDao extends BaseDao<BizOutstockplanDetail> {
    ...
    public List<BizOutstockplanDetail> queryOutstockplanList(String applyNo, String outOrgNo, String productType) {
        ...
        sql.append(" SELECT bod.id,bod.outstock_type,bod.product_no,bod.product_name,bod.product_type,bod.product_categoryname,bod.plan_status,bod.out_orgno,")
            ...
            .append(" WHERE bod.trade_no = :applyNo AND bod.product_type = :productType AND bod.out_orgno = :outOrgno");
    ...
    public void deleteOutStockPlan(String applyNo) {
        Map<String, Object> params = Maps.newHashMap();
        params.put("applyNo", applyNo);
        String sql = " DELETE FROM biz_outstockplan_detail WHERE trade_no = :applyNo ";

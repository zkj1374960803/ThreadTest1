...
public class SearchBizServiceMaintaingroup extends AftersaleCommonEntity{
    /**
     * 保养套餐的编号
     */
    ...
    private List<ProductDetailDTO> saveMaintaintemDTOS;
    /**
     * 零配件集合
     */
    @ApiModelProperty(name = "saveMerchandiseDTOS", value = "零配件集合")
    private List<ProductDetailDTO> saveMerchandiseDTOS;
    ...
    public List<ProductDetailDTO> getSaveMaintaintemDTOS() {
        return saveMaintaintemDTOS;
    }

    public void setSaveMaintaintemDTOS(List<ProductDetailDTO> saveMaintaintemDTOS) {
        this.saveMaintaintemDTOS = saveMaintaintemDTOS;
    }

    public List<ProductDetailDTO> getSaveMerchandiseDTOS() {
        return saveMerchandiseDTOS;
    }

    public void setSaveMerchandiseDTOS(List<ProductDetailDTO> saveMerchandiseDTOS) {

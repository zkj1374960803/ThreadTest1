 ...
 */
@Api(tags = "问题件申请管理（客户经理端）")
@RestController
@RequestMapping("/platform/custmanagerproblemallocateapply")
public class CustmanagerProblemAllocateApplyController extends BaseController {
    @Resource
